package com.example.notifyserver.common.config.jwt;

import com.example.notifyserver.common.exception.model.UnAuthorizedException;
...
import static com.example.notifyserver.common.exception.enums.ErrorCode.TOKEN_TIME_EXPIRED_EXCEPTION;
...
public class JwtService {
    ...
    public boolean verifyToken(final String token) throws UnAuthorizedException {
        try {
